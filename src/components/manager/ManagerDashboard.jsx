...
export default function ManagerDashboard() {
  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden" dir="rtl">
      {/* ---- Desktop Sidebar ---- */}
      <div className="hidden lg:flex flex-shrink-0 sticky top-0 h-screen overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        {/* Mobile top bar */}
        <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100 shadow-sm sticky top-0 z-10">
          <button
